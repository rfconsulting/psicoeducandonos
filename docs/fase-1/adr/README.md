...
| ADR | Estado | Decisión |
|---|---|---|
| [ADR-001](ADR-001-MONOLITO-MODULAR.md) | Aceptado | Evolucionar el monolito modular. |
| [ADR-002](ADR-002-CUENTA-Y-PERFIL.md) | Aceptado | Separar cuenta y perfil. |
| [ADR-003](ADR-003-APPLICACIONES-LEGACY.md) | Aceptado | Preservar postulaciones como legado. |
